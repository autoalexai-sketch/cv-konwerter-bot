...
def get_premium_kb(lang: str) -> InlineKeyboardMarkup:
    if lang == 'pl':
        btn_text = "Kup Premium (9,99 zł) 💎"
    elif lang == 'uk':
        btn_text = "Купити Преміум (9,99 zł) 💎"
    else:
        btn_text = "Buy Premium (9,99 zł) 💎"
